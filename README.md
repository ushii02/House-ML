...
1Regression-Predict the exact sale price of a house
2Classification-Predict if a house is expensive or affordable
3ARIMA-Forecast how average prices trend over time
...
arima_forecast.png12-period price forecast
...
Place train.csv in the same folder and rename it to house_prices.csv
Run the script:
